...
import {SafeAreaView,StyleSheet,Text,View,FlatList,ScrollView,AppRegistry,TouchableOpacity,} from "react-native";
...
export default class Graph extends React.Component {
    ...
    componentDidMount() {
      ...
      kpiId = data;
        ...
        console.log( kpiId);
      fetch(
        "http://192.168.0.119:8000/api/kpisd/100?kpiId=" +kpiId,
        {
          method: "GET",
          headers: {
